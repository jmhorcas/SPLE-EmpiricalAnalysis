...
SAMPLES = 5
FILENAME = "energy-encryption.csv"

if __name__ == "__main__":
	results = energymeter.experiment_variable_values("java -Xmx16g -jar DESede_BC.jar ", VARIABLE_VALUES, PROCESS_NAME, INTERVALS_SECONDS, SAMPLES)
