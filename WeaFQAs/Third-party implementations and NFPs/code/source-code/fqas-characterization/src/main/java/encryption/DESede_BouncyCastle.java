...
public class DESede_BouncyCastle {
	// mode CBC and padding PKCS5Padding by default.
	private static final String ALGO = "DESede";
	private static final byte[] keyValue = new byte[] { 'T', 'h', 'e', 'B', 'e', 's', 't', 'S', 'e', 'c', 'r','e', 't', 'K', 'e', 'y', 'e', 'c', 'r','e', 't', 'K', 'e', 'y' };
    private static Cipher c;
    
    public DESede_BouncyCastle() throws Exception {
    	// Key key = generateKey();
